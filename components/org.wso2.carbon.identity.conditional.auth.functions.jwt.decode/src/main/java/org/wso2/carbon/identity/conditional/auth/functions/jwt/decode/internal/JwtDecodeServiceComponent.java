...
package org.wso2.carbon.identity.conditional.auth.functions.jwt.decode.internal;
...
public class JwtDecodeServiceComponent {

    private static final Log LOG = LogFactory.getLog(JwtDecodeServiceComponent.class);

    @Activate
    protected void activate(ComponentContext ctxt) {

        try {
            JwtDecodeImpl authParameterFunctions = new JwtDecodeImpl();
            JsFunctionRegistry jsFunctionRegistry = JwtDecodeServiceHolder.getInstance()
    ...
    public void setJsFunctionRegistry(JsFunctionRegistry jsFunctionRegistry) {
        ...
        JwtDecodeServiceHolder.getInstance().setJsFunctionRegistry(jsFunctionRegistry);
    }

    public void unsetJsFunctionRegistry(JsFunctionRegistry jsFunctionRegistry) {

        JwtDecodeServiceHolder.getInstance().setJsFunctionRegistry(null);
    }
