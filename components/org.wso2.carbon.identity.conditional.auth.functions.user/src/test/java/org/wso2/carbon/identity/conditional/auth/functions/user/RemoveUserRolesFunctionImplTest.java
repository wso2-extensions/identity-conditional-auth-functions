...
public class RemoveUserRolesFunctionImplTest {
    ...
    public void testCrossTenantScenarioReturnsFalse() {
        ...
        RemoveUserRolesFunctionImpl removeUserRolesFunction = new RemoveUserRolesFunctionImpl();
        boolean result = removeUserRolesFunction.removeUserRoles(jsUser, roles);
