 ...
 */
public class GrpcJsonFunctionImpl implements GrpcJsonFunction {

    private static final Log log = LogFactory.getLog(GrpcJsonFunctionImpl.class);

    @Override
    public String sendJson(String host, String port, Object params) {
        ...
        if (params instanceof Map) {
            ...
            String jsonResponse = clientStub.sendJson(jsonRequest).getJsonString();
