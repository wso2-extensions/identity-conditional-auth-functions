 ...
 * @see UserSession
 */
public class NashornJsUserSession extends AbstractJSObjectWrapper<UserSession> implements JsUserSession {

    private UserAgent userAgent;

    public NashornJsUserSession(UserSession wrappedUserSession) {
    ...
    public Object getMember(String name) {
        ...
        switch (name) {
            case "userAgent":
                return new NashornJsUserAgent(userAgent);
            case "ip":
            ...
            case "applications":
                return getWrapped().getApplications().stream().map(NashornJsApplication::new).collect(Collectors.toList());
            default:
