...
import org.wso2.carbon.identity.conditional.auth.functions.siddhi.Constants;
import org.wso2.carbon.identity.core.util.IdentityUtil;

import static org.wso2.carbon.identity.conditional.auth.functions.siddhi.Constants.HTTP_CONNECTION_REQUEST_TIMEOUT;
import static org.wso2.carbon.identity.conditional.auth.functions.siddhi.Constants.HTTP_READ_TIMEOUT;
...
public class ConfigProvider {
    ...
    private ConfigProvider() {
        ...
        String connectionTimeoutString = IdentityUtil.getProperty(Constants.HTTP_CONNECTION_TIMEOUT);
