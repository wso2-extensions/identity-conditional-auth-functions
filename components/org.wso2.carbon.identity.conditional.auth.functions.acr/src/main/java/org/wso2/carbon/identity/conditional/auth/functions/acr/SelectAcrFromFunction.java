...
import org.wso2.carbon.identity.conditional.auth.functions.acr.internal.AcrFunctionsServiceComponent;
...
/**
 * Function Implementation to select best ACR from Possible ACRs.
 */
public class SelectAcrFromFunction implements SelectOneFunction {

    private static final Log log = LogFactory.getLog(org.wso2.carbon.identity.conditional.auth.functions.acr.SelectAcrFromFunction.class);
    ...
    private String[] extractPossibleOutcomes(JsAuthenticationContext context, Object possibleOutcomesObj) {
        ...
        if (possibleOutcomesObj instanceof Object[]) {
            Object[] possibleOutcomesObjArray = (Object[]) possibleOutcomesObj;
            possibleOutcomes = Arrays.copyOf(possibleOutcomesObjArray, possibleOutcomesObjArray.length, String[].class);
            ...
            if (((ScriptObjectMirror) possibleOutcomesObj).isArray()) {
                ...
                log.error("Invalid argument provided for possible outcomes for " + AcrFunctionsServiceComponent
